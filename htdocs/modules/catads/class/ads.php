...
//ajout CPascalWeb - 12 novembre 2010 - option tel portable
		$this->initVar('phoneportable', XOBJ_DTYPE_TXTBOX, null, false);
//fin			
...
//ajout fonction CPascalWeb - 17 septembre posibilité de suspendre ou de réactivé une annonce			
		$this->initVar('suspendadmin', XOBJ_DTYPE_INT, 0, false);		
//fin
//ajout fonction CPascalWeb - 5 novembre 2010 signalement d'une annonce frauduleuse				 
		$this->initVar('signalementannonce', XOBJ_DTYPE_INT, 0, false);		 
//fin		
...
//ajout fonction CPascalWeb - 17 septembre posibilité de suspendre ou de réactivé une annonce (suspendadmin)
//ajout fonction CPascalWeb - 5 novembre 2010 signalement d'une annonce frauduleuse	
//ajout CPascalWeb - 12 novembre 2010 - option tel portable
//modif CPascalWeb - 18 mai 2011 supp expired_mail_send et ('.$this->db->quoteString($expired_mail_send).') plus besoin envoi mail automatique	
			$sql = 'INSERT INTO '.$this->db->prefix('catads_ads').' (
					...
					VALUES (
						...
						'.$this->db->quoteString($phoneportable).',						
			...
			$sql = 'UPDATE '.$this->db->prefix('catads_ads').' SET 
				...
				phoneportable='.$this->db->quoteString($phoneportable).',				
				...
				signalementannonce='.$signalementannonce.',					
				waiting='.$waiting.' ,
...
//fin ajout fonction CPascalWeb - suspendadmin et signalementannonce		
//echo $sql;
