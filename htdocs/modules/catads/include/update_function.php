...
//ajout CPascalWeb - 12 novembre 2010 - option tel portable
        ...
        if( ! $result )
        {
                $result = $xoopsDB->queryF("ALTER TABLE `".$xoopsDB->prefix("catads_ads")."` ADD pays VARCHAR(10) DEFAULT 'FRANCE' NOT NULL AFTER phoneportable");
        }		
//fin		
...
//ajout CPascalWeb - images type pour les annonces		
