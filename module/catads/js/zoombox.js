...
zoombox = {
	 ...
	 *     	CONFIGURATION
	 * **********************************/
	Dwidth : 		640, 		//largeur par défaut
	Dheight: 		480,		//hauteur par défaut
	duration:		750,		// durée animation (ms)
	animation:		"all",		// animé la taille de la boîte ?  (all: tous,  img: animation que sur les img, no: pas d'animation)
	maskOpacity:	0.4,		// Opacité du fond noir,
	FLVPlayer:		"/js/zoombox/FLVplayer.swf",   // URL de FLV Player
	MP3Player:	"/js/zoombox/MP3player.swf",  // URL de MP3 Player
	allowOverflow:	true,	// ajuster automatiquement la largeur/hauteur de la zone si le contenu est plus large que la fenêtre
	bindable:		"a[rel^='zoombox']",  // (jQuery expression) appel zoombox dans les liens <a .... rel='zoombox'>
	theme:		"default", 			// Définir le thème à utiliser
	fixed:		false,			// faire défiler la boîte afin de suivre ou non la page

	/**
	 * définir ici votre propre structure personnalisée pour créer un nouveau look pour la boîte (\ at the end of lines are used to make multiline string)
	 *	IMPORTANT ELEMENTS
	 *	#zoombox			=> Nécessaire pour sélectionner tous les éléments de boîte (ne pas supprimer !)
	 *	.zoombox_close 	=> A Cliquez sur ces éléments fermer la boîte de
	 *	#zoombox_aplat	=> Le fond noir
	 *	#zoombox_content	=> Le contenu sera mis ici
	 *	#zoombox_title span		=> Titre du lien sera affiché ici
	 *	#zoombox_next, zoombox_prev => Cliquable bouton utilisé pour naviguer dans la galerie
	 * */
	themes:{
		"default" :	 '\
			<div id="zoombox"> \
...
//modif CPascalWeb - 14 novembre 2010				
