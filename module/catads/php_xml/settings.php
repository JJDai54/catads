...
//INFORMATIONS SUR CE FICHIER: dans ce fichier tous les paramètres à definir pour personnaliser et configurer la carte
define ('retour', "\r\n"); // Ne pas modifier
...
$hote			= '';                // Nom de votre serveur SQL
$utilisateur	= '';                // Nom d'utilisateur SQL
$motDePasse		= '';				 // Mot de passe SQL
$baseDeDonnees	= '';                // Nom de la base de données 
$tableUtilisee	= '????_catads_ads'; // PREFIXE de la table utilisée 
...
$champSuspendAdmin = 'suspendadmin';
//fin
// Champs facultatifs
...
//ajout CPascalWeb - 11 novembre 2010 - tel portable
$champFacultatifs['phoneportable'] = 'Portable';
//fin
